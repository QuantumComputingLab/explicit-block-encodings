function circuit = tridiag_cab(n,alpha,beta,gamma)
%TRIDIAG_CAB  Block-encoding circuit of circulant tridiagonal matrix.
%   circuit = TRIDIAG_CAB(n,a,b,c) constructs the quantum circuit that
...
%
%   [circuit,OA,OC,D] = TRIDIAG_CAB(n,a,b,c) also returns the OA, OC, and
