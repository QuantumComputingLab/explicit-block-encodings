function [circuit,OA,OC,D] = tridiag_ucry(n,alpha,beta,gamma)
%TRIDIAG_UCRY   Block-encoding circuit of circulant tridiagonal matrix.
%   circuit = TRIDIAG_UCRY(n,a,b,c) constructs the quantum circuit that
...
%
%   [circuit,OA,OC,D] = TRIDIAG_UCRY(n,a,b,c) also returns the OA, OC, and
